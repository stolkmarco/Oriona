...
export default function CopilotWidget() {
  ...
  return (
    <div className="fixed z-[9999] bottom-4 right-4">
      {open && (
        <div className="mb-3 w-[380px] max-w-[96vw] h-[600px] max-h-[70vh] rounded-2xl overflow-hidden ring-1 ring-black/10 dark:ring-white/10 bg-white dark:bg-[#0f1220] shadow-2xl">
      ...
      <button
        ...
        className="rounded-full px-4 py-3 ring-1 ring-black/10 dark:ring-white/10 bg-black/5 hover:bg-black/10 dark:bg-white/5 dark:hover:bg-white/10 flex items-center gap-2 transition"
