...
export default function ThemeToggle(){
  ...
  return (
    <button
      ...
      className="flex items-center gap-2 rounded-xl px-3 py-2 ring-1 ring-black/10 dark:ring-white/10 bg-black/5 hover:bg-black/10 dark:bg-white/5 dark:hover:bg-white/10 transition"
