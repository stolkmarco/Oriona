  ...
  return (
    <main className="max-w-7xl mx-auto px-4 py-10">
      ...
      <section className="grid md:grid-cols-2 gap-5 mt-10">
        <GlowCard href="/project-navigator">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="mt-3"><span className="inline-flex items-center gap-2 text-sm px-3 py-2 rounded-lg bg-black/5 dark:bg-white/5">Launch Module →</span></div>
            </div>
          </div>
        </GlowCard>
        <GlowCard href="/market-telescope">
          <div className="flex items-center gap-3">
        ...
        <GlowCard href="/knowledge-constellation">
          <div className="flex items-center gap-3">
